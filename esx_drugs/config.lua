...
Config.CircleZones = {
	...
	DrugDealer2 = {coords = vector3(2403.5, 3127.6, 48.2), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 25.0},
	DrugDealer3 = {coords = vector3(-560, 5282.8, 73.1), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 25.0}
}